 ...
 * החוברת המדפדפת בוטלה — החומרים מוצגים בעמודי אינטרנט אחידים: שער עם
 * ארבעה קיצורים (3.26), עמוד שכבה לכל כיתה, ועמוד משאב מחולק (הטמעה מול פעולות).
 ...
 * בעמוד המשימה המחולק (הוראת יניב, 06/08/2026 — מחליף את קפיצת העוגן אל
 * עמוד החוזר המלא). לצדו אין לוח פעולות גנרי — רק דפדוף עמודים בתוך הטווח
 * (הוראת יניב, 10/08/2026, RULES 9.3.11). `title` מאפשר לשמור את הכותרת
 * המדויקת שהוצגה לשכבה.
 */
